...
//FX STEP Full Vel --------------------------------------- Win + inicio ------------------------------------------------------------------------//  
   case 785: //  
      sendSysExDef(0x00, 0x18, 0x02, 0x7f); // Volumen 127
...
// Step Seq Pads Patterns
 ...
 case 257: // Configuracion para los Patterns del Step Seq ------------------------------ ( Bloq Num )  ------------------------------------------------------------------------------------------//
        ...
        sendSysExDef(0x00, 0x07, 0x00, 0x03); // CsemicorcheaSS
        sendSysExDef(0x00, 0x08, 0x19, 0x00); // instrumento 12 (SFX) en All
        sendSysExDef(0x00, 0x08, 0x15, 0x00); // instrumento 10 (Perc1) en All
        sendSysExDef(0x00, 0x08, 0x0f, 0x00); // Instrumento 7 (Ride) en All
        break;                                               
   ...
   case 41: //----------------  9  ----------Kick drum 1,5,9,13 y Bordona 5,13 -----------------------//
        ...
        sendSysExDef(0x00, 0x08, 0x0e, 0x31); // Instrumento 7 Bordona Nota C#3
        SSpatternsPad1Lo  (0x01); // 1
        SSpatternsPad2Lo  (0x00); // 2
        SSpatternsPad3Lo  (0x00); // 3
        SSpatternsPad4Lo  (0x00); // 4
   ...
   case 45: //---------------- ( - ) ----------Ride 1,3,5,7,9,11,13,15 -----------------------//
        sendSysExDef(0x00, 0x08, 0x18, 0x41); // Instrumento 12 nota F4        
        SSpatternsPad1Hi  (0x10); // 1
        SSpatternsPad2Hi  (0x00); // 2
        SSpatternsPad3Hi  (0x10); // 3
        SSpatternsPad4Hi  (0x00); // 4
   ...
   case 44: //---------------- (+) ----------HiHatClosed 1,3,5,7,9,11,13,15 y Open 3,7,11,15 -----------------------//
        ...
        sendSysExDef(0x00, 0x08, 0x14, 0x3a); // Instrumento 10 nota A#3    
        SSpatternsPad1Hi  (0x10); // 1
        SSpatternsPad2Hi  (0x00); // 2
