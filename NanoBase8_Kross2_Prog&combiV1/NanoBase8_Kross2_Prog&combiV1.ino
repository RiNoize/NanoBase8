...
// Abierto/Todo Abierto Combi
//Filtro TodoAbierto  ------------------- AltGR -------------------//
   case 5387:
        MIDI.sendControlChange(74, 127, 1);
        break; 
...
//AcousticSSDrumKit 12
   case 20574: // *
        ...
        break; 
/*
 // DRUM TRACK BUS SELECT Combi Track 10---------------------------------------------------WIN key----------------------------------------------------//        

   case 4969: // DKIT---------F9
        sendSysExDef(0x00, 0x12, 0x2b, 0x00); //
        break;
   case 4970: // L/R---------F10
        sendSysExDef(0x00, 0x12, 0x2b, 0x01); //
        break;
   case 4971: // IFX1-------F11
        sendSysExDef(0x00, 0x12, 0x2b, 0x02); //
        break;
   case 4972: // IFX2-------F12
        sendSysExDef(0x00, 0x12, 0x2b, 0x03); //
        break;
   case 5008: // IFX3------Desp
        sendSysExDef(0x00, 0x12, 0x2b, 0x04); //
        break;
   case 5005: // IFX4------Dormir
        sendSysExDef(0x00, 0x12, 0x2b, 0x05); //
        break;
   case 5004: // IFX5------Apagar
       sendSysExDef(0x00, 0x12, 0x2b, 0x06); //
        break;       
*/
